<?php
    ...
    class AddressService extends AbstractService {
        ...
        function getAddressId(Address $address) {
            ...
            $sth = $pdo->prepare("SELECT id FROM address where school = :school and street = :street and zip_code = :zipCode and city = :city and country = :country");
        ...
        function findAddressById($id) : Address {
            ...
            $sql = "
                select school, street, zip_code, city, country
                from address
                where address.id = $id
            ";
            ...
            return (new Address($addressInfos["school"], $addressInfos["street"], $addressInfos["zip_code"], $addressInfos["city"], $addressInfos["country"]))->setId($id);
        }
