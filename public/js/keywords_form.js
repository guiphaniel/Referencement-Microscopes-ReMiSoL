...
function createTag(catId, tagId) {
    ...
    tagWrapper.className = "input-rm-wrapper";

    let inputWrapper = createInputWrapper("tag-" + tagId, `keywords[${catId}][${tagId}]`, "Etiquette");
    ...
    tagWrapper.appendChild(inputWrapper);
    tagWrapper.appendChild(rmBt);
